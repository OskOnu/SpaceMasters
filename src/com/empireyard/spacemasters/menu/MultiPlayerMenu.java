...
public class MultiPlayerMenu implements Screen {
    ...
    public MultiPlayerMenu(final SpaceMasters spaceMasters) {
        ...
        changeSpriteSize(optionButtonsUp.get(2), scaleX, scaleY);
        ...
        optionButtons.get(0).setPosition(menuFrame.getOriginX()-optionButtons.get(0).getOriginX(), 750*scaleY);
        ...
        optionButtons.get(1).setPosition(menuFrame.getOriginX()-optionButtons.get(1).getOriginX(), 550*scaleY);

        optionButtons.add(new ImageButton(new SpriteDrawable(optionButtonsUp.get(2)), new SpriteDrawable(optionButtonDown)));
        optionButtons.get(2).setOrigin(optionButtons.get(2).getWidth()/2, optionButtons.get(2).getHeight()/2);
        optionButtons.get(2).setPosition(menuFrame.getOriginX()-optionButtons.get(2).getOriginX(), 350*scaleY);

        //Navigation buttons init
        navigationButtonsUp = new Array<Sprite>();
        navigationButtonsUp.add(new Sprite(new TextureRegion(spaceMasters.getAssetHandler().getTextureAtlas("main_menu").findRegion("back"))));
        ...
        parameter.size = OPTION_TEXT_FONT_SIZE;
        parameter.characters = "Invitations";
        parameter.color = new Color(0, 255, 255, 1);
        optionsText.add(generator.generateFont(parameter));

        fontsLayout = new GlyphLayout();
        fontsLayout.setText(optionsText.get(2), parameter.characters);
        optionsTextSize.add(new Vector2(fontsLayout.width, fontsLayout.height));
        ...
        optionButtons.get(0).addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                ...
                spaceMasters.setScreen(new VersusMenu(spaceMasters));
            }
        });
        ...
        optionButtons.get(1).addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                ...
                spaceMasters.setScreen(new CoOpMenu(spaceMasters));
            }
        });

        optionButtons.get(2).addListener(new ChangeListener() {
            @Override
            public void changed(ChangeEvent event, Actor actor) {
                Gdx.app.log("optionButtons.get(2): ", "pressed");
                //SpaceMasters.getPlayServices().setGameMode(PlayServices.GameMode.COOP);
                SpaceMasters.getPlayServices().showInvitations();
            }
        });
        ...
        navigationButtons.get(0).addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                ...
                spaceMasters.setScreen(new MainMenu(spaceMasters));
            }
        });
    ...
    public void render(float delta) {
        ...
        optionsText.get(0).draw(spaceMasters.getSpriteBatch(), "Versus", menuFrame.getWidth()/2 - optionsTextSize.get(0).x/2, optionButtons.get(0).getY() + optionButtons.get(0).getHeight()/2 + optionsTextSize.get(0).y/2);
        optionsText.get(1).draw(spaceMasters.getSpriteBatch(), "CO-OP", menuFrame.getWidth()/2 - optionsTextSize.get(1).x/2, optionButtons.get(1).getY() + optionButtons.get(1).getHeight()/2 + optionsTextSize.get(1).y/2);
        optionsText.get(2).draw(spaceMasters.getSpriteBatch(), "Invitations", menuFrame.getWidth()/2 - optionsTextSize.get(2).x/2, optionButtons.get(2).getY() + optionButtons.get(2).getHeight()/2 + optionsTextSize.get(2).y/2);
