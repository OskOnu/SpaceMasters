...
public class VersusMenu implements Screen {
    ...
    public VersusMenu(final SpaceMasters spaceMasters) {
        ...
        optionButtons.get(0).setPosition(menuFrame.getOriginX()-optionButtons.get(0).getOriginX(), 550*scaleY);
        ...
        optionButtons.get(1).setPosition(menuFrame.getOriginX()-optionButtons.get(1).getOriginX(), 350*scaleY);
        ...
        navigationButtonsUp.add(new Sprite(new TextureRegion(spaceMasters.getAssetHandler().getTextureAtlas("main_menu").findRegion("rank"))));
        ...
        parameter.characters = "Quick Game";
        ...
        optionButtons.get(1).addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                ...
                SpaceMasters.getPlayServices().startCustomGame();
            }
        });
        ...
        navigationButtons.get(1).addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                ...
                spaceMasters.getPlayServices().displayVersusLeaderboard();
            }
        });
    ...
    public void render(float delta) {
        ...
        optionsText.get(0).draw(spaceMasters.getSpriteBatch(), "Quick Game", menuFrame.getWidth()/2 - optionsTextSize.get(0).x/2, optionButtons.get(0).getY() + optionButtons.get(0).getHeight()/2 + optionsTextSize.get(0).y/2);
        optionsText.get(1).draw(spaceMasters.getSpriteBatch(), "Invite", menuFrame.getWidth()/2 - optionsTextSize.get(1).x/2, optionButtons.get(1).getY() + optionButtons.get(1).getHeight()/2 + optionsTextSize.get(1).y/2);
