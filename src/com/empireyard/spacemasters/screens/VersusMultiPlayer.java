...
import com.empireyard.spacemasters.handlers.VersusMultiPlayerDataHandler;
...
import com.empireyard.spacemasters.tools.VersusWorldContactListener;

/**
 * Created by osk on 06.02.17.
 */

public class VersusMultiPlayer implements Screen, InputProcessor {
    //Debug
    ...
    VersusMultiPlayerDataHandler multiPlayerDataHandler;
    ...
    public VersusMultiPlayer(SpaceMasters spaceMasters) {
        ...
        playerShips.add(new RemotePlayerShip(spaceMasters.getAssetHandler(), world, "player_ships", "ship", 1, "blue", 10, 10000));
...
//        ));
        ...
        multiPlayerDataHandler = new VersusMultiPlayerDataHandler(playerShips);



        multiPlayerDataHandler.setLeadPlayerId(null);
        while(multiPlayerDataHandler.getLeadPlayerId() == null){
            SpaceMasters.getPlayServices().broadcastData(multiPlayerDataHandler.prepareBroadcastMessage(playerShips.get(0)), false);
        ...
        world.setContactListener(new VersusWorldContactListener(world, playerShips, multiPlayerDataHandler.isHost()));
    ...
    public void update(float dt){
        ...
        multiPlayerDataHandler.implementReceivedData(SpaceMasters.getPlayServices().getReceivedMessageBuffer(), playerShips.get(1));
