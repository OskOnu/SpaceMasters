...
public class VersusMultiPlayerDataHandler {
    ...
    public VersusMultiPlayerDataHandler(Array<PlayerShip> playerShips) {
    ...
    public byte[] prepareBroadcastMessage(PlayerShip playerShip){
        int i = 0;
        //data for ship1
...
//        }
    ...
    public void implementReceivedData(byte[] receivedMessageBuffer, PlayerShip playerShip) {
        int i = 0;
